...
;// CONCATENATED MODULE: ./src/components/Dadata.component/Dadata.component.js
class Dadata {
  static startDadata() {
    $(".input").suggestions({
...
var air_datepicker = __webpack_require__(7545);
...
;// CONCATENATED MODULE: ./src/components/airDatepicker.component/airDatepicker.component.js



class AirDatepickerComponent {
  static startAirDatepicker() {
    new index_es("#input-date", {
      selectedDates: [new Date()]
    });
  }
}
;// CONCATENATED MODULE: ./src/components/aviaSearch.component/aviaSearch.js
...
class AviaSearch {
  ...
  getCounter(title) {
    ...
    counterWraperEl.addEventListener("click", e => {
      if (e.target.classList.contains("counter-botton") && e.target.classList.contains("counter-botton__minus")) {
        this.changeTheQuantityOfPeople(e, "-");
      } else if (e.target.classList.contains("counter-botton") && e.target.classList.contains("counter-botton__plus")) {
        this.changeTheQuantityOfPeople(e, "+");
      }
    });
...
;// CONCATENATED MODULE: ./src/modules/aviaSearch.module.js

class AviaSearchModule {
  constructor(container) {
    this.container = container;
  }
  drowUi() {
...
const app_constructor = document.querySelector(".conteiner");
const aviaSearchModule = new AviaSearchModule(app_constructor);
